function GraphicHE() {
    ...
    GraphicHE.prototype.createCharts = function(arg) {
        ...
        this.acumuladoMeses(arg.totalTeste);
    ...
    GraphicHE.prototype.acumuladoMeses = function(totalTestes) {
        ...
        for (var mes in totalTestes) {

            dadosMeta.push({
                y: parseFloat(totalTestes[mes].sum),
                x: new Date(totalTestes[mes].dt_referencia),
                indexLabel: this.formataMoeda(totalTestes[mes].sum)
            });
        }
        console.log(dadosMeta);
        var chartGeralCedes = new CanvasJS.Chart("GeralCedes", {
            title: {
                text: "Últimos Doze Meses"
            },
